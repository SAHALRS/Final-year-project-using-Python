...
def Club_Add_Vehicle(request):
    ...
    if request.POST:
        ...
        c.execute("insert into club_vehicle(clid,ve_name,cu_cap,reg_no,no_item,rent) values('" +str(clid) +"','"+name+"','"+cap+"','"+regno+"','1','"+rent+"')")
        db.commit()
...
def Club_View_Booking(request):
    ...
    if request.GET:
        ...
        if st =='Accept':
            ...
            c.execute("delete from vehicle_rent where rent_id = '"+str(cl)+"'")
            db.commit()
...
def Shop_Add_Product(request):
    ...
    if request.POST:
        ...
        if request.FILES.get("file"):
            ...
            c.execute("insert into products(product_cat,product_brand,product_title,product_price,quantity,product_desc,product_image,product_keywords,shid) values('"+ str(b) +"','"+ str(c1) +"','"+ str(a) +"','"+ str(d) +"','"+ str(e) +"','"+ str(f) +"','static"+ uploaded_file_url +"','"+ str(g) +"','"+ str(sid) +"')")
            db.commit()       
